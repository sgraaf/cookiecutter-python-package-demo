...
Thank you for your interest in contributing to *cookiecutter-python-package-demo*!
...
To start developing *cookiecutter-python-package-demo*, follow these instructions to setup your development environment:

1. Create a *fork* (your own personal copy) of the *cookiecutter-python-package-demo* repository via https://github.com/sgraaf/cookiecutter-python-package-demo/fork.

1. Clone the repository by replacing `<YOUR-USERNAME>` with your GitHub username:

   ```shell
   git clone https://github.com/<YOUR-USERNAME>/cookiecutter-python-package-demo.git
...
*cookiecutter-python-package-demo* adheres to [the Black code style](https://black.readthedocs.io/en/stable/the_black_code_style/current_style.html) and uses [Ruff](https://docs.astral.sh/ruff/) for linting and formatting code. Make sure your code is formatted properly:
...
*cookiecutter-python-package-demo* uses type hints/annotations throughout, and uses a combination of [mypy](https://mypy.readthedocs.io/en/stable/), [Pyrefly](https://pyrefly.org/), and [ty](https://docs.astral.sh/ty/) to do type checking. Please add type annotations for all new code, and make sure that type checking succeeds:
...
*cookiecutter-python-package-demo* has a comprehensive test suite, which includes smoke tests, unit tests and integration tests, and uses [pytest](https://docs.pytest.org/en/stable/) to execute it:
...
*cookiecutter-python-package-demo* uses [Google Style Python Docstrings](https://www.sphinx-doc.org/en/master/usage/extensions/example_google.html) to document its API:
...
*cookiecutter-python-package-demo* follows the [Keep a Changelog](https://keepachangelog.com/en/1.1.0/) format for its changelog:
...
When your pull request is approved, it will be merged into the `main` branch. Your change will only be available to users the next time *cookiecutter-python-package-demo* is released.
